...
def predict():
    if request.method == "POST":
        ...
        filepath = os.path.join(str(basepath), 'User Images', str(f.filename))
        ...
        print(result)
        account_sid = 'AC040db3f6fc52556d2a15a7c8814238e2'
        auth_token = '1dedefd14bb721ecb05dd4c68dc1ec82'
